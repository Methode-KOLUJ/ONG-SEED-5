    ...
    <footer className="bg-white dark:bg-black py-8 text-black dark:text-white relative">
      ...
      <div className="container mx-auto px-4 relative">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 mt-8">
          ...
          <div>
            <h3 className="text-xl md:text-2xl lg:text-3xl text-center uppercase font-extrabold xl:mb-6 text-teal-600 dark:text-blue-600">
              nos Horaires
            </h3>
          ...
          <div>
            <h3 className="text-xl md:text-2xl lg:text-3xl font-extrabold text-center uppercase xl:mb-6 text-teal-600 dark:text-blue-600">
              suivez-nous
            </h3>
            <ul className="mt-4 space-y-4 flex flex-col items-center">
              <li>
